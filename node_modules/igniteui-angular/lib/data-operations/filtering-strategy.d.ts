...
export declare abstract class BaseFilteringStrategy implements IFilteringStrategy {
    findMatchByExpression(rec: any, expr: IFilteringExpression, isDate?: boolean, grid?: GridType): boolean;
...
export declare class FilteringStrategy extends BaseFilteringStrategy {
    ...
    protected getFieldValue(rec: any, fieldName: string, isDate?: boolean): any;
}
export declare class FormattedValuesFilteringStrategy extends FilteringStrategy {
    ...
    protected getFieldValue(rec: any, fieldName: string, isDate?: boolean, grid?: GridType): any;
}
