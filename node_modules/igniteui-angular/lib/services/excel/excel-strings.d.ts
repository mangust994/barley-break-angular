...
export declare class ExcelStrings {
    ...
    static getStyles(hasNumberValues: boolean, hasDateValues: boolean): string;
    ...
    static getSheetXML(dimension: string, freezePane: string, cols: string, sheetData: string, hasTable: boolean, outlineLevel?: number): string;
