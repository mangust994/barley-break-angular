...
export declare class IgxTabItemComponent extends IgxTabItemBase implements AfterViewInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<IgxTabItemComponent, "igx-tab-item", never, { "icon": "icon"; "label": "label"; "disabled": "disabled"; "isSelected": "isSelected"; "autoGenerated": "autoGenerated"; "relatedGroup": "relatedGroup"; }, {}, ["customTabTemplateDir"], never>;
}
